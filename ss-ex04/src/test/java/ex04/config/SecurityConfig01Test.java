...
public class SecurityConfig01Test {
    ...
    public void testSecurityFilters() {
        ...
        assertEquals("UsernamePasswordAuthenticationFilter", filters.get(6));
        
        //8th DefaultLoginPageGeneratingFilter
        assertEquals("DefaultLoginPageGeneratingFilter", filters.get(7));
        
        //9th DefaultLogoutPageGeneratingFilter
        assertEquals("DefaultLogoutPageGeneratingFilter", filters.get(8));
